  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(getAllUsersAsync.fulfilled, (state, action) => {
        state.getAllUsersStatus = "fulfilled";
        state.allUsers = action.payload;
      })
      .addCase(getAllUsersAsync.rejected, (state, action) => {
        state.getAllUsersStatus = "rejected";
        state.getAllUsersError = action.error;
      });
  },
});
...
export const selectAllUsers = (state) => state.AuthSlice.allUsers;
export const selectGetAllUsersStatus = (state) =>
  state.AuthSlice.getAllUsersStatus;
export const selectGetAllUsersError = (state) =>
  state.AuthSlice.getAllUsersError;
