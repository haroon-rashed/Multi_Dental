...
export const Reviews = ({ productId, averageRating, loggedInUser }) => {
  ...
  // const loggedInUser=useSelector(selectLoggedInUser) // Remove this line since we're getting it as prop
  ...
  const handleWriteReviewClick = () => {
    // Login check before showing review form
    if (!loggedInUser) {
      toast.error("Please log in to add a review");
      navigate("/login");
      return;
