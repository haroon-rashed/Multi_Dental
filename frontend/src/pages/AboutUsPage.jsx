            ...
            <CardContent>
              ...
              <Grid container spacing={3}>
                ...
                <Grid item xs={12} md={6}>
                  ...
                  <Typography
                    variant="body1"
                    sx={{ lineHeight: 1.7, marginBottom: 1 }}
                  >
                    <strong>Phone:</strong> +92614506162, +92614506052
                  </Typography>
                  <Typography
                    variant="body1"
                    sx={{ lineHeight: 1.7, marginBottom: 1 }}
                  >
                    <strong>Email:</strong> info@alumardental.com
                  </Typography>
                  <Typography variant="body1" sx={{ lineHeight: 1.7 }}>
                    <strong>Emergency:</strong> Available 24/7 for urgent orders
                  </Typography>
                </Grid>
              </Grid>
            </CardContent>
