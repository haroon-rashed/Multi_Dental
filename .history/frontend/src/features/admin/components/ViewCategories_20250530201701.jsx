      ...
      >
        <Box sx={{ width: '100%' }}>
          {subcategories.map((subcat, index) => (
            ...
            >
              <TableCell sx={{ pl: 6, width: 'auto', minWidth: '80px' }}>
                <Box display="flex" alignItems="center" gap={1} sx={{ flexWrap: 'nowrap' }}>
                  <Typography variant="body2" color="primary" sx={{ fontWeight: 'bold', flexShrink: 0 }}>
                    ↳
                  </Typography>
              ...
              <TableCell sx={{ width: 'auto', minWidth: '200px' }}>
                <Box display="flex" alignItems="center" gap={2} pl={2} sx={{ flexWrap: 'nowrap' }}>
                  <FaFolder color="#ff9800" size={18} style={{ flexShrink: 0 }} />
                  <Box sx={{ flex: 1, minWidth: 0 }}>
                    <Typography variant="body1" fontWeight={500} color="text.primary" sx={{ 
              ...
              <TableCell sx={{ width: 'auto', minWidth: '120px' }}>
                <Typography variant="body2" color="warning.main" fontWeight="500">
                  Subcategory
                </Typography>
              </TableCell>
              <TableCell align="center" sx={{ width: 'auto', minWidth: '120px' }}>
